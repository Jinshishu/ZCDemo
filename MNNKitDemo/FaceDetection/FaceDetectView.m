...
-(void)setHandDetectResult:(NSArray<MNNHandGestureDetectionReport *> *)handDetectResult
{
    _handDetectResult = handDetectResult;
    ...
    for (int i = 0; i < self.handDetectResult.count; i++) {
        MNNHandGestureDetectionReport *result = _handDetectResult[i];
...
- (void)labelDesp:(MNNHandGestureType)type {
